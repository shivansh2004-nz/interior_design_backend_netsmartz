...
#     m = masks[best_i].astype(np.uint8) * 255
#     return m
...
# ) -> int:
#     """
#     Returns number of objects saved.
#     """
...
#       { "processed_folders": X, "skipped_folders": Y, "total_cutouts": Z }
#     """
...
#             print(f"\n[SKIP] '{folder}' not supported by COCO mapping. Skipping detection.")
#             skipped += 1
#             continue
...
#     return {"processed_folders": processed, "skipped_folders": skipped, "total_cutouts": total_saved}
